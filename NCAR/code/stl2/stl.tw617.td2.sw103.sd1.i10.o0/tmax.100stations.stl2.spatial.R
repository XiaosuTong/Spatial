...
dr <- ddply(tmp, "station.id", function(r){stl2(r$tmax, r$date, n.p=12, t.window = 151, s.window=65, inner = 5, outer = 0)$data})
tmp <- cbind(tmp, dr)
...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmax_seasonal_mean_vs_lat_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmax_seasonal_mean_vs_lon_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmax_seasonal_mean_vs_elev_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
