...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmin_seasonal_mean_vs_lat_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmin_seasonal_mean_vs_lon_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
...
trellis.device(postscript, file = paste(outputdir, "scatterplot_of_tmin_seasonal_mean_vs_elev_for_100_stations_conditional_month",".ps", sep = ""), color=TRUE, paper="legal")
