...
rhsave(list=c("USpinfo", "UStinfo"), file=file.path(rh.datadir, "stationinfo", "USinfo.RData"))
...
tmax <- tmp.tmax[,-8]
rhsave(list=("tmax"), file=file.path(rh.datadir, "tmax","Rdata","tmax.RData"))
tmax.100stations <- subset(tmax, station.id %in% stations.tmax)
rhsave(list=("tmax.100stations"), file=file.path(rh.datadir, "tmax","100stations","Rdata","tmax.100stations.RData"))
...
tmin <- tmp.tmin[,-9]
rhsave(list=("tmin"), file=file.path(rh.datadir, "tmin","Rdata","tmin.RData"))
tmin.100stations <- subset(tmin, station.id %in% stations.tmin)
rhsave(list=("tmin.100stations"), file=file.path(rh.datadir, "tmin","100stations","Rdata","tmin.100stations.RData", sep=""))
...
precip <- tmp.precip
rhsave(list=("precip"), file=file.path(rh.datadir, "precip","Rdata","precip.RData"))
precip.100stations <- subset(precip, station.id %in% stations.precip)
rhsave(list=("precip.100stations"), file=file.path(rh.datadir, "precip","100stations","Rdata","precip.100stations.RData", sep=""))
rm("tmin", "tmp", "tmin.100stations")
